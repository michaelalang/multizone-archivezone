...
radosgw-admin zone create --rgw-zonegroup=${RGWREGION} --rgw-zone=${RGWZONE} --access-key=eastwestrepl --secret=eastwestrepl123456789  --endpoints=http://${RGWZONE}-rgw.${DOMAIN}:${RGWPORT}
